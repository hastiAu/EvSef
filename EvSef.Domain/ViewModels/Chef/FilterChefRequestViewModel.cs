...
{
    public class FilterChefRequestListViewModel : BasePagination
    {
        ...
        public FilterChefRequestListViewModel SetPaging(BasePagination basePaging)
        {
        ...
        public FilterChefRequestListViewModel SetUsers(List<Entities.Account.Chef> chefs)
        {
            Chef = chefs;
