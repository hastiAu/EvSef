...
namespace EvSef.Infra.Data.Migrations
{
    ...
    [Migration("20240607102222_updateSiteSettingDB2")]
    partial class updateSiteSettingDB2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChefFoodCorporationFood", b =>
                {
                    b.Property<int>("ChefFoodsChefFoodId")
                        .HasColumnType("int");

                    b.Property<int>("CorporationFoodsCorporationFoodId")
                        .HasColumnType("int");

                    b.HasKey("ChefFoodsChefFoodId", "CorporationFoodsCorporationFoodId");
            ...
            modelBuilder.Entity("EvSef.Domain.Entities.BeComeChef.BeComeChef", b =>
                {
                    b.Property<int>("BeComeChefId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("BeComeChefId"));

                    b.Property<string>("BeComeChefImage")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("BeComeChefTitle")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("EvSef.Domain.Entities.CustomFood.CustomFood", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CustomFoodId"));
                    ...
                    b.Property<string>("CustomFoodImage")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("EvSef.Domain.Entities.Food.CorporationFood", b =>
                {
                    b.Property<int>("CorporationFoodId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CorporationFoodId"));
                    ...
                    b.Property<DateTime>("CorporationOrderFromDate")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("CorporationOrderToDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("EvSef.Domain.Entities.FoodPrice.ChefFoodPrice", b =>
                {
                    ...
                    b.Property<decimal>("ChefFoodPriceDiscount")
            ...
            modelBuilder.Entity("EvSef.Domain.Entities.Instagram.Instagram", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("InstagramId"));
            ...
            modelBuilder.Entity("EvSef.Domain.Entities.MainSlider.MainSlider", b =>
                {
                    b.Property<int>("MaidSliderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MaidSliderId"));
            ...
            modelBuilder.Entity("EvSef.Domain.Entities.Order.Order", b =>
                {
                    ...
                    b.Property<decimal>("OrderTotalDiscountAmount")
                        .HasColumnType("decimal(18,4)");

                    b.Property<decimal>("OrderTotalTaxAmount")
                        .HasColumnType("decimal(18,4)");
            ...
            modelBuilder.Entity("EvSef.Domain.Entities.OrderDetails.OrderDetails", b =>
                {
                    ...
                    b.Property<decimal>("OrderFoodAmount")
                        .HasColumnType("decimal(18,4)");

                    b.Property<string>("OrderFoodDescription")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<decimal>("OrderFoodDiscountAmount")
                        .HasColumnType("decimal(18,4)");

                    b.Property<decimal>("OrderFoodTaxAmount")
                        .HasColumnType("decimal(18,4)");
            ...
            modelBuilder.Entity("EvSef.Domain.Entities.OurService.OurService", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("OurServiceId"));
                    ...
                    b.Property<string>("OurServiceFontName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("EvSef.Domain.Entities.SiteSetting.SiteSetting", b =>
                {
                    ...
                    b.Property<string>("CorporationFormTitle1")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("FoodMenuTitle")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("HowOrderCorporationFoodTitle")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("OurChefTitle")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("EvSef.Domain.Entities.SocialMedia.SocialMedia", b =>
                {
                    ...
                    b.Property<string>("SocialMediaIconName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ChefFoodCorporationFood", b =>
                {
                    b.HasOne("EvSef.Domain.Entities.Food.ChefFood", null)
                        .WithMany()
                        .HasForeignKey("ChefFoodsChefFoodId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("EvSef.Domain.Entities.Food.CorporationFood", null)
                        .WithMany()
                        .HasForeignKey("CorporationFoodsCorporationFoodId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("EvSef.Domain.Entities.Order.Order", b =>
                {
                    b.HasOne("EvSef.Domain.Entities.UserType.Client", "Client")
                        .WithOne("Order")
                        .HasForeignKey("EvSef.Domain.Entities.Order.Order", "ClientId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("EvSef.Domain.Entities.ContactInfo.ContactInfo", "ContactInfo")
                        .WithMany()
            ...
            modelBuilder.Entity("EvSef.Domain.Entities.OrderDetails.OrderDetails", b =>
                {
                    b.HasOne("EvSef.Domain.Entities.Food.ChefFood", "ChefFood")
                        ...
                        .HasForeignKey("EvSef.Domain.Entities.OrderDetails.OrderDetails", "ChefFoodId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("EvSef.Domain.Entities.Order.Order", "Order")
