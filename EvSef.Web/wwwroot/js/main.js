...
$(document).ready(function () {
    ...
    $(document).on("click", ".navbar-toggler", () => {
        if ($(".navbar-toggler").hasClass("clicked")) {
            ...
            $(".overlay-section").removeClass("show");
            $("html").removeClass("overlay");
        }
        else {
            $(".navbar-toggler").addClass("clicked");
            $(".navbar-collapse").addClass("show");
            $(".overlay-section").addClass("show");
    ...
    //Food Menu & Add To card Js

    $(document).on("click",
        ".tab-pane.active .menu-img img",
        function() {
    ...
    $(document).on("click",
        ".food-menu-days .nav-item",
        function() {
            $(".food-menu-days .nav-link").removeClass("active");
    ...
    $(document).ready(function () {
        ...
        function openLoginModal(url) {
            $.get(url).done(function (data) {
                ...
                console.log("Failed to load login modal from " + url);
            });
        }
        ...
        $(document).on('click', '.cart-button', function (event) {
            ...
            if (!isAuthenticated) {
                ...
                var url = '/Login?returnUrl=' + encodeURIComponent(returnUrl);
                openLoginModal(url);
            } else {
                console.log("User is authenticated. Proceeding to cart.");
                return true;
            }
        });
